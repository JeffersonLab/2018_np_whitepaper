...
the decay $\Xi_b^{\prime 0}\to\Xi_b^-\pi^+$ appears to be kinematically forbidden. The widths of the $\Xi_b^{*0}$, $\Xi_b^{*-}$, and $\Xi_b^{\prime -}$ were correctly predicted by a lattice QCD calculation of the heavy-baryon
axial couplings \cite{Detmold:2012ge}. More generally, the widths of selected heavy-baryon resonances (those coupling to two-body channels only)
