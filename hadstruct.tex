...
A variety of other approaches are also being investigated to access hadronic structure in more detail than it has been previously.
These methods are predominantly based on computatons of the hadronic tensor.


FInally, the approach advocated by Davoudi and Savage for resortaion of rotational symmetry has been generalised to attack the 
problem of hihg moemnts of PDFs through the construction of complicated lattice operators in which the Euclidean SO(4) symmetry is approximately restored thereby suppressing mixing with lower dimensional operators and avoiding that which is power divergent in the continuum limit.
...
GPDs are defined as  moff-forward matrix elements of the same operators that define parton distributions. For the unpolarised case
